...
VALUES ('2023 SW코칭 프로그램 - 스프링프레임워크', 'NORMAL', '스프링프레임워크로 웹애플리케이션 개발실무를 익히고 코드리뷰를 진행',
        '/images/default-team.png', '2023-01-10T00:00:00.000000', '2023-01-10T00:00:00.000000',(SELECT id FROM app_user WHERE email='sjyskku99@g.skku.edu')),
       ...
       ('SSA', 'NORMAL', 'SW중심대학사업에 필요한 웹 서비스 개발 및 운영에 참여 (서비스 기획 및 디자인, 웹 서비스 프론트엔드 및 백엔드 개발 및 운영, 인프라 보안 운영, 콘텐츠 운영)',
        '/images/ssa.png', '2023-01-10T00:00:00.000000', '2023-01-10T00:00:00.000000', (SELECT id FROM app_user WHERE email='sjyskku99@g.skku.edu'));
...
VALUES ('Hello World!!', '운영자', '자유게시판의 첫글입니다.', '2023-01-10T00:00:00.000000', '2023-01-10T00:00:00.000000', 1, (SELECT id FROM app_user WHERE name='서정엽')),
